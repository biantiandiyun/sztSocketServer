...
//		System.out.println(getDateFripmstring("19801111","yyyyMMdd","yyyy-MM-dd HH:mm:ss"));
//		System.out.println(getXAgoMonth(new Date(),2,"yyyyMMdd"));
//		System.out.println(getDateBeforeXDay(getDate("20121212","yyyyMMdd"),10,"yyyyMMdd"));
//		System.out.println(getDate("20121212","yyyyMMdd"));
//		System.out.println(getDifferMonth(getDate("20121212","yyyyMMdd"), getDate("20151112","yyyyMMdd")));
		System.out.println(getNowLongStr());
	}
}
