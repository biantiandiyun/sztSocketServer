...
import com.lakala.ips.util.TLV;
...
public final class SAXUnionFiled55Utils
{
	...
	{
		/*String str = "kQo1L5y7fd1zGzAwchKGEATan3kKAAAAAAEAtG+quACfGAQAAAAB";
		str = Hex.encode(Base64.decode(str));
		System.out.println(str);
		List<TLV> list = SAXUnionFiled55Utils
				.saxUnionField55_2List(str);
		for (TLV tlv : list)
		{
			System.out.println(tlv);
		}*/
//		Map<String, TLV> map = SAXUnionFiled55Utils.saxUnionField55_2Map(str);
//		TLV tlv = map.get("9F26");
//		System.out.println(tlv.getValue());
//		System.out.println(SAXUnionFiled55Utils.saxUnionField55_2List("910A2B33DA1DFA028A2F30309F1804000000017212861004DA9F790A000000010000BF22CDA500"));
//		String ss = "910A2B33DA1DFA028A2F30309F1804000000017211861004DA9F790A000000010000BF22CDA500";
//		System.out.println(new String(Base64.encode(Hex.decode(ss))));
		
//		String icc55 = "kQrNYkekYvScZzAwchKfGAQAAAABhhAE2p95CgAAAAABAGDvGhQA";
//		 byte[] rslt = (Base64.decode(icc55.getBytes()));
//		 System.out.println(rslt);
//		String sss = "9F180400000001861004DA9F790A000000010000BF22CDA500";
//		System.out.println(sss.substring(14));
//		System.out.println(sss.substring(0, 14));
		
		String tcicc55 = "nyYIHSXQfUmfyEKfEBMHFQEDYKAQAQoBAAABAgArdqW5nzcERQOOTJ82AgBulQUIAADoAJoDFREQggJ8AJ8aAgFWnzMD4OnInx4IMDAwMDAwMDHfMQUgAAAAAA==";
		tcicc55 = Hex.encode(Base64.decode(tcicc55));
		System.out.println(tcicc55);
		List<TLV> list = SAXUnionFiled55Utils
				.saxUnionField55_2List(tcicc55);
		for (TLV tlv : list)
		{
			System.out.println(tlv);
		}
