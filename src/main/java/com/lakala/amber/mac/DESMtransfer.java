package com.lakala.amber.mac;


import java.io.UnsupportedEncodingException;

/**
 * 3DES/ECB 算法（与受理加密算法一致，双倍长密钥）
 */
public class DESMtransfer {
    ...
    public static int[] string2Binary(String source) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            for (int j = str.length - 1; j >= 0; j--) {
                ...
                dest[k] = Integer.parseInt(String.valueOf(str[j]));
    ...
    */
    ...
    public static String encryption(String D, String K) {
        ...
        DESMtransfer dt = new DESMtransfer();
        subKey = dt.genKey(K);
        for (int i = 1; i < 17; i++) {
    ...
    */
    ...
    /**
     * 主密钥或者工作密钥加密.
     * <p>用来解密受理分发的主密钥或者工作密钥</P>
     * @param source 加密后的密文（(16字节)）
     * @param key  密钥(16字节)
     * @return 解密后明文(16字节)
     */
    public static String decrypt(String source, String key) {
        ...
        if (key.length() != 32 || source.length() != 32) {
            ...
            String a = DES_3(source.substring(0, 16), key, 1);
            String b = DES_3(source.substring(16), key, 1);
    ...
    */
    ...
    public int[][] genKey(String source) {
    ...
    */
     ...
     */
     ...
     public static String MACWeb(String key, String vector, String data, int type) {

    	 
    	 //16字节左半部分密钥（8字节16位16进制字符）
         String K1 = key.substring(0, key.length() / 2);
         //16字节右半部分密钥（8字节16位16进制字符）
         String K2 = key.substring(key.length() / 2);
